...
/**
 * Next 16 generates global `PageProps` helpers during `next build`; this app is
 * built by vinext for Workers, so route params are typed explicitly instead.
 */
interface DocsPageProps {
  params: Promise<{ slug?: string[] }>
}

export default async function Page(props: DocsPageProps): Promise<ReactElement> {
